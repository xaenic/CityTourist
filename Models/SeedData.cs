        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Place.Any())
            {
              ...
              new Place
              {
                  ...
                  Routes = "Route 1: From Cebu City, take a bus or private car southbound on the Cebu South Road towards Badian. Follow directional signs to Kawasan Falls, which is approximately a 3-hour drive.\nRoute 2: If coming from Moalboal or Oslob, Kawasan Falls is accessible by land via the coastal highway. Follow the main road towards Badian and look for signs directing you to the falls.",
                  Images = new string[]
    {
...
new Place
{
    ...
    Routes = "Route: From Mactan-Cebu International Airport, take a taxi or ride-hailing service to Cebu City. Magellan's Cross is located near the Basilica Minore del Santo Niño, which is approximately a 30-minute drive depending on traffic.",
    Images = new string[]
    {
...
new Place
{
    ...
    Routes = "Route: From Cebu City, take Transcentral Highway towards Busay. Follow the signs leading to Tops Lookout, which is approximately a 30-45 minute drive from the city center.",
    Images = new string[]
    {
...
new Place
{
    ...
    Routes = "Route: From Cebu City center, Fort San Pedro is easily accessible by taxi or jeepney. It is located near Plaza Independencia, making it a short drive or walk from many central locations in the city.",
    Images = new string[]
    {
...
new Place
{
    ...
    Routes = "Route: From Laoag City, take a jeepney or tricycle to Paoay. The church is centrally located in the town and is approximately a 20-minute drive from Laoag.",
    Images = new string[]
    {
...
new Place
{
    ...
    Routes = "Route: From Laoag City, take a bus or van bound for Pagudpud. The journey takes approximately 2-3 hours, and the town is accessible via the Pan-Philippine Highway (AH26).",
    Images = new string[]
    {
...
new Place
{
    ...
    Routes = "Route: From Legazpi City, take a jeepney or tricycle to Cagsawa Ruins for a close-up view of Mayon Volcano. Other viewpoints like Lignon Hill are also easily accessible from the city center.",
    Images = new string[]
    {
...
new Place
{
    ...
    Routes = "Route: From Manila, take the North Luzon Expressway (NLEX) to Angeles City. The journey takes approximately 1.5 to 2 hours by car or bus. Angeles City is also accessible via Clark International Airport, which is a short drive from the city center.",
    Images = new string[]
    {
